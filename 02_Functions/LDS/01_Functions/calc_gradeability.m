...
text_output = 0;                                %output text on or off
...
%calculate alpha - equation from "Fahrzeugdynamik - Mechanik des bewegten Fahrzeugs - Stefan Breuer, Andrea Rohrbach-Kerl
%DOI: 10.1007/978-3-658-09475-1 - S. 94
