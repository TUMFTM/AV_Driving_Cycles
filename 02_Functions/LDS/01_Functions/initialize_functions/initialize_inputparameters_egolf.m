function [vehicle,Parameters] = initialize_inputparameters_egolf()
%% Description: VW-eGolf
...
vehicle.Input.vehicle_empty_weight      =   1600 - 75;      %empty weight netto in kg (no driver) %1400 / 1698.2-75
vehicle.Input.vehicle_sim_cons_weight   =   1698.2;         %vehicle weight for energy consumption sim, optional
...
vehicle.Input.vehicle_width             =   1799;           %vehicle width in mm
vehicle.Input.vehicle_height            =   1482;           %vehicle height in mm
vehicle.Input.wheelbase                 =   2629;           %wheelbase in mm
vehicle.Input.ground_clearance          =   'flatfloor';    %ground clearance (more than 200mm ==> highfloor, otherwise flatfloor)                 
vehicle.Input.driving_cycle             =   'egolf_d3_011';         %driving cycle (cycle are in folder 04_Drive_Cycle) %egolf_d3_0xx
...
vehicle.Input.max_speed                 =   140;            %maximum velocity in km/h
...
vehicle.Input.T_max_Mot_f               =  270;         %max torque of front machine in Nm
...
vehicle.Input.acceleration_time_req     =   10.4;    %required acceleration time in s

%Motor characteristic inputs
vehicle.Input.characteristic_forced = {'PSM_M270_n12000_0.2.mat',NaN};  %select forced characteristic per axle, otherwise NaN, f.e. characteristic_forced = {'PSM_M270_n12000_0.2.mat',NaN};
