function [vehicle,Parameters] = initialize_inputparameters_amperae(vehicle)
...
vehicle.Input.vehicle_empty_weight      =   1616;           %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   NaN;            %vehicle weight for energy consumption simulation (optional, otherwise NaN)
vehicle.Input.r_tire                    =   323.5;            %static tire radius in mm 
vehicle.Input.w_tire                    =   215;            %tire width in mm, (Optional, needed for e_i calculation)
vehicle.Input.vehicle_width             =   1765;           %vehicle width in mm
vehicle.Input.vehicle_height            =   1594;           %vehicle height in mm
vehicle.Input.wheelbase                 =   2600;           %wheelbase in mm
...
vehicle.Input.i_gearbox_f               =   9.26;          %gear ratio front
vehicle.Input.i_gearbox_r               =   NaN;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  360;         %max torque of front machine in Nm
...
vehicle.Input.eta_gearbox_f             =   0.97;            %efficiency of front gearbox, optional
