...
vehicle.Input.vehicle_empty_weight      =   1580-75;           %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   1497.8;            %vehicle weight for energy consumption simulation (optional, otherwise NaN)
