function [vehicle,Parameters] = initialize_inputparameters_eup(vehicle)
%% Description: VW e-up! 2020
...
vehicle.Input.vehicle_empty_weight      =   1235-75;        %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   NaN;            %vehicle weight for energy consumption sim, optional
vehicle.Input.r_tire                    =   293.3;            %static tire radius in mm 
vehicle.Input.w_tire                    =   165;            %tire width in mm, (Optional, needed for e_i calculation)
vehicle.Input.vehicle_width             =   1645;           %vehicle width in mm
vehicle.Input.vehicle_height            =   1507;           %vehicle height in mm
vehicle.Input.wheelbase                 =   2417;           %wheelbase in mm
...
vehicle.Input.i_gearbox_f               =   8.160;          %gear ratio front
vehicle.Input.i_gearbox_r               =   NaN;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  212;         %max torque of front machine in Nm
...
vehicle.Input.c_d                       =   0.308;            %air resistance coefficient, (optional)
