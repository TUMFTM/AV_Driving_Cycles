function [vehicle,Parameters] = initialize_inputparameters_sparkev(vehicle)
%% Description: Chevrolet Spark EV 2015
...
vehicle.Input.number_passengers         =   4;              %Number of passengers
vehicle.Input.vehicle_empty_weight      =   1300;        %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   1432;            %vehicle weight for energy consumption sim, optional
vehicle.Input.r_tire                    =   292;            %static tire radius in mm 
vehicle.Input.w_tire                    =   185;            %tire width in mm, (Optional, needed for e_i calculation)
vehicle.Input.vehicle_width             =   1627;           %vehicle width in mm
vehicle.Input.vehicle_height            =   1590;           %vehicle height in mm
vehicle.Input.wheelbase                 =   2375;           %wheelbase in mm
vehicle.Input.ground_clearance          =   'flatfloor';    %ground clearance (more than 200mm ==> highfloor, otherwise flatfloor)                 
vehicle.Input.driving_cycle             =   'FTP72';         %driving cycle (cycle are in folder 04_Drive_Cycle)
vehicle.Input.power_auxiliaries         =    0.52;               %power of auxiliary users in kW. (optional, otherwise NaN)
...
vehicle.Input.max_speed                 =   145;            %maximum velocity in km/h
...
vehicle.Input.i_gearbox_f               =   3.87;          %gear ratio front
vehicle.Input.i_gearbox_r               =   NaN;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  444;         %max torque of front machine in Nm
...
vehicle.Input.acceleration_time_req     =   7.6;    %required acceleration time in s
...
vehicle.Input.c_d                       =   0.326;            %air resistance coefficient, (optional)
