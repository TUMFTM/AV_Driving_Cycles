function [vehicle,Parameters] = initialize_inputparameters_focuse(vehicle)
%% Description: Ford Focus electric 2013
...
vehicle.Input.vehicle_empty_weight      =   1700-75;        %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   1790;            %vehicle weight for energy consumption sim, optional
...
vehicle.Input.vehicle_width             =   1823;           %vehicle width in mm
vehicle.Input.vehicle_height            =   1484;           %vehicle height in mm
vehicle.Input.wheelbase                 =   2650;           %wheelbase in mm
...
vehicle.Input.power_auxiliaries         =    0.33;               %power of auxiliary users in kW. (optional, otherwise NaN)
...
vehicle.Input.max_speed                 =   137;            %maximum velocity in km/h
...
vehicle.Input.i_gearbox_f               =   7.82;          %gear ratio front
vehicle.Input.i_gearbox_r               =   NaN;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  250;         %max torque of front machine in Nm
...
vehicle.Input.acceleration_time_req     =   11.4;    %required acceleration time in s
...
vehicle.Input.ratio_req = [0.4,0.3];              %select required angular speed ratio per axle
...
vehicle.Input.c_r                       =   0.010;            %roll resistance coefficient, (optional)
vehicle.Input.c_d                       =   0.295;            %air resistance coefficient, (optional)
