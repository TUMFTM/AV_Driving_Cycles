function [vehicle,Parameters] = initialize_inputparameters_imiev(vehicle)
%% Description: Mitsubishie i-Miev 2012
...
vehicle.Input.vehicle_empty_weight      =   1110;        %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   1304;            %vehicle weight for energy consumption sim, optional
vehicle.Input.r_tire                    =   278;            %static tire radius in mm 
vehicle.Input.w_tire                    =   175;            %tire width in mm, (Optional, needed for e_i calculation)
vehicle.Input.vehicle_width             =   1475;           %vehicle width in mm
vehicle.Input.vehicle_height            =   1610;           %vehicle height in mm
vehicle.Input.wheelbase                 =   2550;           %wheelbase in mm
...
vehicle.Input.power_auxiliaries         =    0.07;               %power of auxiliary users in kW. (optional, otherwise NaN)
...
vehicle.Input.max_speed                 =   130;            %maximum velocity in km/h
...
vehicle.Input.i_gearbox_r               =   7.065;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  NaN;         %max torque of front machine in Nm
vehicle.Input.T_max_Mot_r               =  180;         %max torque of rear machine in Nm
...
vehicle.Input.acceleration_time_req     =   15.9;    %required acceleration time in s
...
vehicle.Input.ratio_req = [0.3,0.2];              %select required angular speed ratio per axle
...
vehicle.Input.c_r                       =   0.011;            %roll resistance coefficient, (optional)
vehicle.Input.c_d                       =   0.330;            %air resistance coefficient, (optional)
