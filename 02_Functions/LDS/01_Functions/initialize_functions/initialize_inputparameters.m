function [vehicle,Parameters] = initialize_inputparameters(vehicle)
%% Description:
...
%% 1) Section where the user can assign the Inputparameters
%%----------------------------------------------------Vehicle Inputs----------------------------------------------------
vehicle.Input.topology                  =   '2G2M_GM';        %vehicle topology. See functions initialize powertrain
...
vehicle.Input.vehicle_empty_weight      =   1200;           %empty weight netto in kg (no driver)
...
vehicle.Input.i_gearbox_f               =   [10, 8, 5];          %gear ratio front
vehicle.Input.i_gearbox_r               =   [10, 8, 5];         %gear ratio rear
...
vehicle.Input.acceleration_time_req     =   14;    %required acceleration time in s
...
Parameters.LDS.correction_gearbox       =   0.9045;     %correction factor for gear ratio (for electric vehicles) in [-].
...
Parameters.LDS.eta_battery              =   0.92;                           %fix efficiency of battery in [-]. Source [8]
...
Parameters.LDS.torque_optimizer         =   1;                            %Torque optimizer if only one engine is overloaded - on/off (1/NaN)
