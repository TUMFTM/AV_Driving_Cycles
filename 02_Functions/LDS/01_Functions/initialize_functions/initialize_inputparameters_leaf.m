function [vehicle,Parameters] = initialize_inputparameters_leaf(vehicle)
%% Description: Nissan Leaf (ZEO) 2012
...
vehicle.Input.vehicle_empty_weight      =   1642-75;           %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   1699.2;            %vehicle weight for energy consumption simulation (optional, otherwise NaN)
...
vehicle.Input.vehicle_height            =   1545;           %vehicle height in mm
vehicle.Input.wheelbase                 =   2690;           %wheelbase in mm
...
vehicle.Input.power_auxiliaries         =    0.18;               %power of auxiliary users in kW. (optional, otherwise NaN)
...
vehicle.Input.i_gearbox_f               =   7.9377;          %gear ratio front
vehicle.Input.i_gearbox_r               =   NaN;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  280;         %max torque of front machine in Nm
...
vehicle.Input.acceleration_time_req     =   11.9;    %required acceleration time in s
