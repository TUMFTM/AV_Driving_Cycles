function [vehicle,Parameters] = initialize_inputparameters_soulev(vehicle)
%% Description: Kia Soul EV
...
vehicle.Input.vehicle_empty_weight      =   1565-75;        %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   NaN;            %vehicle weight for energy consumption sim, optional
vehicle.Input.r_tire                    =   326;            %static tire radius in mm 
vehicle.Input.w_tire                    =   205;            %tire width in mm, (Optional, needed for e_i calculation)
vehicle.Input.vehicle_width             =   1800;           %vehicle width in mm
vehicle.Input.vehicle_height            =   1593;           %vehicle height in mm
...
vehicle.Input.power_auxiliaries         =    0.12;               %power of auxiliary users in kW. (optional, otherwise NaN)
...
vehicle.Input.i_gearbox_f               =   8.21;          %gear ratio front
vehicle.Input.i_gearbox_r               =   NaN;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  285;         %max torque of front machine in Nm
...
vehicle.Input.acceleration_time_req     =   11.2;    %required acceleration time in s
...
vehicle.Input.c_r                       =   0.0088;            %roll resistance coefficient, (optional)
vehicle.Input.c_d                       =   0.3;            %air resistance coefficient, (optional)
