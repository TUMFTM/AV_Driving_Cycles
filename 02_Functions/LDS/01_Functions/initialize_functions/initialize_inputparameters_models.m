function [vehicle,Parameters] = initialize_inputparameters_models(vehicle)
%% Description: Tesla Model S Standard Range 2019
...
vehicle.Input.vehicle_empty_weight      =   2223-75;           %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   NaN;            %vehicle weight for energy consumption simulation (optional, otherwise NaN)
vehicle.Input.r_tire                    =   351.5;            %static tire radius in mm 
vehicle.Input.w_tire                    =   245;            %tire width in mm, (Optional, needed for e_i calculation)
vehicle.Input.vehicle_width             =   1964;           %vehicle width in mm
vehicle.Input.vehicle_height            =   1445;           %vehicle height in mm
vehicle.Input.wheelbase                 =   2960;           %wheelbase in mm
...
vehicle.Input.i_gearbox_f               =   [9.34];          %gear ratio front
vehicle.Input.i_gearbox_r               =   [9.73];         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  330;         %max torque of front machine in Nm
vehicle.Input.T_max_Mot_r               =  440;         %max torque of rear machine in Nm
...
vehicle.Input.c_r                       =   0.01;            %roll resistance coefficient, (optional)
vehicle.Input.c_d                       =   0.24;            %air resistance coefficient, (optional)
