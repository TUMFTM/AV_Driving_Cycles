function [v] = initialize_powertrain_GM_GM(v, Par)
%% Description:
%This functions initializes a powertrain configuration for one machine, one gearbox on each axle.
...
% Gearbox front 
% only single gear. Include also the gear ratio of the differential
