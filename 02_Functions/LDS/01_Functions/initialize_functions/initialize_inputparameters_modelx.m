function [vehicle,Parameters] = initialize_inputparameters_modelx(vehicle)
%% Description: Tesla Model X 100D 2018
...
vehicle.Input.vehicle_empty_weight      =   2459-75;           %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   NaN;            %vehicle weight for energy consumption simulation (optional, otherwise NaN)
vehicle.Input.r_tire                    =   368.75;            %static tire radius in mm 
vehicle.Input.w_tire                    =   255;            %tire width in mm, (Optional, needed for e_i calculation)
vehicle.Input.vehicle_width             =   1999;           %vehicle width in mm
vehicle.Input.vehicle_height            =   1684;           %vehicle height in mm
vehicle.Input.wheelbase                 =   2965;           %wheelbase in mm
...
vehicle.Input.max_speed                 =   250;            %maximum velocity in km/h
...
vehicle.Input.i_gearbox_f               =   [9.325];          %gear ratio front
vehicle.Input.i_gearbox_r               =   [9.325];         %gear ratio rear
...
vehicle.Input.acceleration_time_req     =   4.9;    %required acceleration time in s
...
vehicle.Input.c_d                       =   0.25;            %air resistance coefficient, (optional)
