function [vehicle,Parameters] = initialize_inputparameters_bclass(vehicle)
%% Description: Mercedes Benz B-Class Electric Drive 2015
...
vehicle.Input.vehicle_empty_weight      =   1725-75;        %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   1926;            %vehicle weight for energy consumption sim, optional
...
vehicle.Input.vehicle_width             =   1786;           %vehicle width in mm
vehicle.Input.vehicle_height            =   1557;           %vehicle height in mm
vehicle.Input.wheelbase                 =   2699;           %wheelbase in mm
...
vehicle.Input.power_auxiliaries         =    0.21;               %power of auxiliary users in kW. (optional, otherwise NaN)
...
vehicle.Input.i_gearbox_f               =   9.73;          %gear ratio front
vehicle.Input.i_gearbox_r               =   NaN;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  340;         %max torque of front machine in Nm
...
vehicle.Input.acceleration_time_req     =   7.9;    %required acceleration time in s
