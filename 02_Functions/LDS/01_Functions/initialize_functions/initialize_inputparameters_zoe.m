function [vehicle,Parameters] = initialize_inputparameters_zoe(vehicle)
%% Description: Renault Zoe R110 2019
...
vehicle.Input.vehicle_empty_weight      =   1502;        %empty weight netto in kg (no driver)
vehicle.Input.vehicle_sim_cons_weight   =   NaN;            %vehicle weight for energy consumption sim, optional
vehicle.Input.r_tire                    =   310.75;            %static tire radius in mm 
vehicle.Input.w_tire                    =   185;            %tire width in mm, (Optional, needed for e_i calculation)
vehicle.Input.vehicle_width             =   1787;           %vehicle width in mm
vehicle.Input.vehicle_height            =   1562;           %vehicle height in mm
vehicle.Input.wheelbase                 =   2588;           %wheelbase in mm
...
vehicle.Input.max_speed                 =   135;            %maximum velocity in km/h
...
vehicle.Input.i_gearbox_f               =   9.35;          %gear ratio front
vehicle.Input.i_gearbox_r               =   NaN;         %gear ratio rear

vehicle.Input.T_max_Mot_f               =  225;         %max torque of front machine in Nm
