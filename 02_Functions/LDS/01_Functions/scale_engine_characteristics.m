...
%% Description: 
%This fucntion scales motor diagram and motor characteristics according to
%T_max an n_max

%author:    Nicoletti Lorenzo, Korbinian Moller, FTM, TUM
%date:      29.05.2020
%% Inputs:
% machine type
% low, medium or high rotating
%% Outputs:
% characteristic torque over rotational speed
...
for i=find(filled_axles)
    ...
    %% 1) Scale the motor characteristics
    ...
    %% 2) Load motor front efficiency map and select only the first quadrant
