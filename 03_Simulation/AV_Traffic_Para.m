...
% Version: Matlab2020b
%-------------
% Description: running AVDC(Autonomous Vehicle Driving Cycle) simulation with parameters
% ------------
...
clear variables;
try
    cd 'D:\Studium\SS21\Masterarbeit\03_Programm\03_Simulation'
    run_mode = 'local';
catch
    % Lehrstuhl-Rechner
...
savename = 'ref_ARRoad'; % name for saving workspace
